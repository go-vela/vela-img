...
LD_FLAGS = -X github.com/go-vela/vela-img/version.Commit=${GITHUB_SHA} -X github.com/go-vela/vela-img/version.Date=${BUILD_DATE} -X github.com/go-vela/vela-img/version.Go=${GOLANG_VERSION} -X github.com/go-vela/vela-img/version.Tag=${GITHUB_TAG}
...
build-static-ci:
	@echo
	@echo "### Building CI static release/vela-img binary"
	@go build -a \
		-ldflags '-s -w -extldflags "-static" ${LD_FLAGS}' \
		-o release/vela-img \
		github.com/go-vela/vela-img/cmd/vela-img
