...
func TestImg_Config_Validate(t *testing.T) {
	// setup types
	c := &Config{
		Password: "superSecretPassword",
		URL:      "index.docker.io",
...
func TestImg_Config_Validate_NoPassword(t *testing.T) {
	// setup types
	c := &Config{
		URL:      "index.docker.io",
		Username: "octocat",
...
func TestImg_Config_Validate_NoURL(t *testing.T) {
	// setup types
	c := &Config{
		Password: "superSecretPassword",
		Username: "octocat",
...
func TestImg_Config_Validate_NoUsername(t *testing.T) {
	// setup types
	c := &Config{
		Password: "superSecretPassword",
		URL:      "index.docker.io",
